...
class AutoCompleteData:
    ...
    def print(self, text):
        ...
        if (first_index == -1):
            print(self.complete_sent + " ( the source from " + str(self.sorce_file) + " in line " + str(
            ...
            print(self.complete_sent[end_index:] + " ( the source from " + str(self.sorce_file) + " in line " + str(
                self.offset) + " score : " + str(self.score) + " )")
